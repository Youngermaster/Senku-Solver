...
interface FalsePositionTableProps {
  data: {
    iteration: number
    xi: number
    xs: number
...
export default function FalsePositionTable({ data }: FalsePositionTableProps) {
