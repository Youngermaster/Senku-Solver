import { type SORIteration } from '@/utils/algorithms/sor'
import {
  Card,
  CardContent,
  CardDescription,
...
export default function SORTable({ iterations }: SORTableProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Evolución de las variables en cada iteración del método SOR
