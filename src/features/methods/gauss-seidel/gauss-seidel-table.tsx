import { type GaussSeidelIteration } from '@/utils/algorithms/gauss-seidel'
import {
  Card,
  CardContent,
  CardDescription,
...
interface GaussSeidelTableProps {
  iterations: GaussSeidelIteration[]
}

export default function GaussSeidelTable({
  iterations,
}: GaussSeidelTableProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Evolución de las variables en cada iteración del método de
          Gauss-Seidel
